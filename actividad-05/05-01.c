/*
    Realizar una función que devuelva la posición de un elemento buscado o -1 si no lo encuentra,
    int buscarSecuencial(int vector[], int longitud, int buscado) que implemente el algoritmo de búsqueda
    secuencial de manera iterativa
    --------------------------------------------------------------------------------------------------------
*/
