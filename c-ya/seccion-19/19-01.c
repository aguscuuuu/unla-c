/*
	...
	Definir un vector de 5 componentes de tipo float en la funci�n main que representen las
	alturas de 5 personas.
	Desarrollar las siguientes funciones:
	1-Carga del vector.
	2-Retornar el promedio del vector.
	float calcularPromedio(float alturas[5])
	3-Contar y luego imprimir cu�ntas personas son m�s altas que el promedio y cu�ntas m�s
	bajas.
