/*
	...
	Cargar en una matriz los nombres de 5 pa�ses y en un vector
	paralelo la cantidad de habitantes del mismo. Ordenar alfab�ticamente
	e imprimir los resultados. Por �ltimo ordenar con respecto a la cantidad
