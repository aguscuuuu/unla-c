/*
	...
	Se tiene la siguiente informaci�n:
	� Nombres de 4 empleados (matriz de tipo char)
	� Ingresos en concepto de sueldo, cobrado por cada empleado, en los �ltimos 3 meses (matriz
	de tipo float)
	Confeccionar el programa para:
	a) Realizar la carga de la informaci�n mencionada.
	b) Generar un vector que contenga el ingreso acumulado en sueldos en los �ltimos 3 meses
	para cada empleado.
	c) Mostrar por pantalla el total pagado en sueldos a todos los empleados en los �ltimos 3
	meses
