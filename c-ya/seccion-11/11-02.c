/*
	...
	corriente
	se conoce: n�mero de cuenta y saldo actual. El ingreso de datos debe finalizar al ingresar
	un valor
	negativo en el n�mero de cuenta. Se pide confeccionar un programa que lea los datos de las
	cuentas
	corrientes e informe: el n�mero de cada cuenta y estado de la cuenta seg�n su saldo,
	sabiendo que:
