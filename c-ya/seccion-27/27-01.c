/*
	...
	Definir tres variables de tipo pa�s y almacenar los nombres de los pa�ses y la cantidad de
	habitantes de dichos pa�ses.
	Mostrar seguidamente el nombre del pa�s con mayor cantidad de habitantes (considerar que
	los tres pa�ses tienen cantidades distintas)
    --------------------------------------------------------------------------------------------------------
*/
#include <stdio.h>
#include <stdlib.h>
