/*
	...
	Definir tres variables de tipo punto y cargarlas llamando a una funci�n
	que retorne valores de tipo punto.
	Finalmente crear otra funci�n que imprima en que cuadrante se encuentra
	cada punto (tener en cuenta que si x>0 e y>0 se encuentra en el primer cuadrante,
	si x<0 e y>0 se encuentra en el segundo cuadrante y as� sucesivamente)
    --------------------------------------------------------------------------------------------------------
*/
#include <stdio.h>
#include <stdlib.h>
