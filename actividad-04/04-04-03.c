/*
    Sabiendo que los strings en realidad son arrays de char terminados en 0, escribir y probar la siguiente
    función sin utilizar las funciones definidas en la biblioteca string.h:
    Devolver n carácteres comenzando desde la posición m
    --------------------------------------------------------------------------------------------------------
*/
