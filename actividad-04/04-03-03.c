/*
    ...
    Realizar un programa en C que pida un string al usuario y lo muestre invertido. Si el usuario ingresó
    "prueba", el programa deberá mostrar "abeurp" por pantalla.
    --------------------------------------------------------------------------------------------------------
*/
