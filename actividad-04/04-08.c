/*
    Escribir una función esPar que reciba un entero y devuelva true o false dependiendo de si el número recibido
    es par o no, empleando la función de esMultiploDe
    --------------------------------------------------------------------------------------------------------
*/
